...
- DOCX export now inserts empty paragraphs before and after each documentation cell so prose, equations, and plots aren't clumped together. Only affects the docx pipeline; markdown export is unchanged.

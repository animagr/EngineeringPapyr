import { BaseCell, type DatabaseWcaCell } from "./BaseCell";
...
export default class WcaCell extends BaseCell {
  ...
  constructor(arg?: DatabaseWcaCell) {
    super("wca", arg?.id);
    if (arg === undefined) {
